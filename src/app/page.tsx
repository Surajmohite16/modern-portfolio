...
export const metadata: Metadata = {
  title: 'Suraj Mohite - Senior AWS Cloud Engineer | AWS, Kubernetes, Docker',
  description: 'Professional and Cloud Engineer portfolio showcasing expertise in AWS, Kubernetes, Docker, CI/CD pipelines, and infrastructure automation. View my projects and experience.',
  alternates: {
  ...
  return (
    <div className="min-h-screen min-w-screen" >
      ...
      <div className="sr-only">
        <h1>Suraj Mohite - Cloud Engineer and DevOps Specialist </h1>
        <p>
