...
export const metadata: Metadata = {
  title: 'Suraj Mohite - DevOps & Cloud Engineer Portfolio | AWS, Kubernetes, Docker',
  description:
  ...
  authors: [{ name: 'Suraj Mohite' }],
  creator: 'Suraj Mohite',
  publisher: 'Suraj Mohite',
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    title: 'Suraj Mohite - DevOps & Cloud Engineer Portfolio',
    ...
    siteName: 'Suraj Mohite Portfolio',
    images: [
      {
        url: '/profile-pic.png',
        width: 1200,
        height: 630,
        alt: 'Suraj Mohite - DevOps & Cloud Engineer',
      },
    ],
  },
  // twitter: {
