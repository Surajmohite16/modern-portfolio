...
export const metadata: Metadata = {
  title: 'DevOps Best Practices 2024 - Complete Guide by Suraj Mohite',
  description: 'Comprehensive guide to DevOps best practices including CI/CD, infrastructure as code, monitoring, and security. Learn from experienced DevOps engineer Suraj Mohite.',
  keywords: [
