            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">surajmohite405@gmail.com</span>
                  <button
                    title="Copy email address"
                    onClick={() => copyToClipboard('surajmohite405@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+91 7387184159</span>
                  <button
                    title="Copy phone number"
                    onClick={() => copyToClipboard('+91 7387184159', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Pune, Maharashtra</span>
                </div>
              </div>
            </motion.div>
