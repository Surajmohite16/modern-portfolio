...
export const timelineData: TimelineItem[] = [
  {
    ...
    company: 'Hostin services Private Limited (Cloud.in)',
    location: 'On Site - Pune, India',
    imageURL: '/elevatelabs.jpg',
    date: 'Apr 2025 - Present',
    description: 'Working on real-time projects to gain hands-on experience in modern Cloud & DevOps practices.',
    achievements: [
