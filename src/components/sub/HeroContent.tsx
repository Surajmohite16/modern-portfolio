      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
            <h2 title="Senior AWS Cloud Engineer" className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-blue-500 to-primary bg-clip-text text-transparent mb-3">
        ...
        >
          Building Secure, Scalable, Reliable, and Automated AWS Infrastructure.
        </motion.p>
      </motion.div>
        ...
        <div className="flex items-center gap-3">
          <TrackableContact method="github">
            <NavbarButton
              ...
              href="https://www.linkedin.com/in/surajmohite-cloud-devops-engineer"
            >
